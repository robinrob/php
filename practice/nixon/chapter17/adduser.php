...
function validate(form) {
	...
	fail += validateSurname{form.username.value)
	fail += validateSurname{form.password.value)
	fail += validateSurname{form.age.value)
	fail += validateSurname{form.email.value)
	if (fail == "") { return true }
